 ...
 * @author johan
 */
public class Ejercicio1_Login extends javax.swing.JFrame {

    /**
     * Creates new form Ejercicio1_Login
     */
    public Ejercicio1_Login() {
        initComponents();
        this.setTitle("Login");
    ...
    private void ButtonIniciarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonIniciarActionPerformed
        if("alumno@ulp.edu.ar".equals(email.getText()) && "12345678".equals(pass.getText())){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ejercicio1_Login.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ejercicio1_Login().setVisible(true);
            }
        });
    }
